/**
 * Pin configuration for the IES LumenPNP.
 * Please include this file in every firmware build
 */
/**
...
// Servos
//
#define SERVO0_PIN                          PB6 // correct - changed with I2C Pins
#define SERVO1_PIN                          PB7 // correct
...
// Steppers
//
#define X_STEP_PIN                          PB15    // correct
#define X_DIR_PIN                           PB14    // correct
#define X_ENABLE_PIN                        PD9     // correct
#define X_SERIAL_TX_PIN                     PD8
#define X_SERIAL_RX_PIN                     PD8

#define Y_STEP_PIN                          PE15    // correct
...
// Pin configuration for Left Head
...
#define K_STEP_PIN                          PD6 // Not connected
#define K_DIR_PIN                           PD7 // Not connected
#define K_ENABLE_PIN                        PA3 // Not connected
...
// I2C
#define I2C_SDA_PIN                         PB10 // originally PB7
#define I2C_SCL_PIN                         PB11 // originally PB6
